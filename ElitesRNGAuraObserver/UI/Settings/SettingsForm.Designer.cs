...
partial class SettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        label8 = new Label();
        label9 = new Label();
        fixed3dLineControl1 = new ElitesRNGAuraObserver.UI.Controls.Fixed3DLineControl();
        fixed3dLineControl2 = new ElitesRNGAuraObserver.UI.Controls.Fixed3DLineControl();
        fixed3dLineControl3 = new ElitesRNGAuraObserver.UI.Controls.Fixed3DLineControl();
        label10 = new Label();
        fixed3dLineControl4 = new ElitesRNGAuraObserver.UI.Controls.Fixed3DLineControl();
        ...
        MaximizeBox = false;
        Name = "SettingsForm";
        Text = "Elite's RNG Aura Observer Settings";
